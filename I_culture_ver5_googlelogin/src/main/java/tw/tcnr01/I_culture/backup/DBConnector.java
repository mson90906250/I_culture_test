package tw.tcnr01.I_culture.backup;
...
//-------000webhost   給專題的測試php
            //HttpPost httpPost = new HttpPost("https://tcnr1091601.000webhostapp.com/I_culture/android_connect_db_for_i_culture_test.php"); //組長的
            HttpPost httpPost = new HttpPost(uri); //shop
